...
namespace ego_planner
{
  ...
  void EGOReplanFSM::getLocalTarget()
  {
    ...
    for (t = planner_manager_->global_data_.last_progress_time_; t < planner_manager_->global_data_.global_duration_; t += t_step)
    {
      ...
      // cout << "t=" << t << " last_progress_time_=" << planner_manager_->global_data_.last_progress_time_ << endl;
      ...
      if (dist >= planning_horizen_)
      {
        ...
        // cout << "case1" << " local_target_pt_=" << local_target_pt_.transpose() << endl;
        break;
      }
    }
    if (t > planner_manager_->global_data_.global_duration_) // Last global point
    {
      ...
      // cout << "case2" << " local_target_pt_=" << local_target_pt_.transpose() << endl;
    }
    // cout << "case3" << " local_target_pt_=" << local_target_pt_.transpose() << endl;
