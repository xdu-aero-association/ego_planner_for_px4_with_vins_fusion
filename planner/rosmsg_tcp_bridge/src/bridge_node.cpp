...
int main(int argc, char **argv)
{
  ...
  one_traj_sub_ = nh.subscribe("/broadcast_bspline_from_planner", 100, one_traj_sub_udp_cb, ros::TransportHints().tcpNoDelay());
  one_traj_pub_ = nh.advertise<traj_utils::Bspline>("/broadcast_bspline_to_planner", 100);
