...
void HovThrKF::update(double a) {
    ...
    //     ROS_WARN("[px4ctrl.hover] Reach percent_lower_limit %f", x(0));
    // }
    // if (x(0) == param.hover.percent_higher_limit) {
    //     ROS_WARN("[px4ctrl.hover] Reach percent_higher_limit %f", x(0));
    // }
}
...
void HovThrKF::simple_update(Eigen::Quaterniond q, double u, Eigen::Vector3d acc) {
    ...
    // std::cout << "acc_des=" << acc_des.transpose()  << " acc_body2_filter=" << acc_body2_filter <<  std::endl;
